...
BEGIN {
    ...
    require '/home/jellepoland/ownCloud/phd/code/OpenSourceAWE/SymbolicAWEModels.jl/openssl-3.3.0/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/jellepoland/ownCloud/phd/code/OpenSourceAWE/SymbolicAWEModels.jl/openssl-3.3.0/test/fips-and-base.cnf';
    shift;
